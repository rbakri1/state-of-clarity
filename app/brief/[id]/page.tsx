          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="mb-6">
                ...
                {expandedSections.factors && (
                  <div className="space-y-4">
                    {(brief.structured_data.factors as Factor[]).map((factor: Factor, i: number) => (
                      <div
                        key={i}
                        className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg"
                      >
              ...
              <div className="mb-6">
                ...
                {expandedSections.policies && (
                  <div className="space-y-4">
                    {(brief.structured_data.policies as Policy[]).map((policy: Policy, i: number) => (
                      <div
                        key={i}
                        className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg"
                      >
              ...
              <div>
                ...
                {expandedSections.consequences && (
                  <div className="space-y-4">
                    {(brief.structured_data.consequences as Consequence[]).map((consequence: Consequence, i: number) => (
                      <div
                        key={i}
                        className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg"
                      >
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {(brief.sources as Source[]).map((source: Source) => (
                  <a
                    key={source.id}
                    href={source.url}
                    target="_blank"
