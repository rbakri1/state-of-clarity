  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div className="clarity-gradient h-24" />

        <div className="px-6 pb-6">
          <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-12">
            <div className="w-24 h-24 rounded-full bg-white dark:bg-gray-800 border-4 border-white dark:border-gray-800 shadow-lg overflow-hidden flex items-center justify-center">
              {avatarUrl ? (
                <img
                  src={avatarUrl}
                  alt={displayName}
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            <div className="text-center p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50">
              ...
              <div className="text-2xl font-bold">{stats.briefsGenerated}</div>
            ...
            <div className="text-center p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50">
              ...
              <div className="text-2xl font-bold">{stats.briefsSaved}</div>
              <div className="text-sm text-muted-foreground">Briefs saved</div>
            </div>
            <div className="text-center p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50">
              <div className="flex items-center justify-center gap-2 text-muted-foreground mb-1">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link
              href="/profile/saved"
              className="flex items-center gap-3 p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition"
            >
              <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
                <Bookmark className="w-5 h-5 text-primary" />
              </div>
              <div>
                <div className="font-medium">Saved Briefs</div>
